    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <p data-aos="fade-up" data-aos-delay="100">Comptez sur des récompenses, des économies, des perspectives et bien plus encore avec tout compte admissible. Seulement à SGROUPFI.</p>
        </h3>
        ...
        <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
          <img src="{{ asset('') }}assets/img/cyber-fraud-Banner-small_402x.jpg" class="img-fluid mb-3 mb-lg-0" alt="">
        </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up">
            ...
            <div>
              ...
              <h4 class="title">Bourses et Aides Sociaux</h4>
              <p class="description">Trouvez de bourses d'études pour enfants.Protection des orphelins et personnes malheureuses...</p>
              <a href="service-details.html" class="readmore stretched-link"><span>Lire plus</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          <!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
            ...
            <div>
              <h5 class="title">Immobilier/Transport/Agriculture</h5>
              <p class="description">Payez directement en magasin, en toute sécurité, à l’aide de votre carte....</p>
              <a href="service-details.html" class="readmore stretched-link"><span>Lire plus</span><i class="bi bi-arrow-right"></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="200">
            ...
            <div>
              ...
              <p class="description">Payez directement en immobilier,ecommerce, etc, en toute sécurité, à l’aide de votre carte...</p>
              <a href="service-details.html" class="readmore stretched-link"><span>Lire plus</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
