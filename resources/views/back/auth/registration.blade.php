                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <div class="col-12">
                      ...
                      <label for="yourFirstnameName" class="form-label">Votre prénom</label>
                      <input type="text" name="firstname" class="form-control" id="yourFirstnameName" required>
                      <div class="invalid-feedback">S'il vous plaît entrez votre nprénomom!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Vous avez déjà un compte ? <a href="pages-login.html">Se connecter</a></p>
                    </div>
                  </form>
