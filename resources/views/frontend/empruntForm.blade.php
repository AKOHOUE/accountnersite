        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Emprunter</h2>
              <p>J'ai besoin d'un pret d'argent pour un problème.
    ...
    <section id="get-a-quote" class="get-a-quote">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-7">
            		<form id="SignupForm" action="{{ route('front.emprunter') }}" method="post" enctype="multipart/form-data" class="php-email-form">
			            @csrf
                  @if($errors->all())
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-6">
                                  <span for="montant">Montant de pret</span>
                  <input type="number" name="montant" class="form-control" value="{{ old('montant') }}" placeholder="Somme à emprunter" required>
                   @if($errors->has('montant'))
                        <div class="alert alert-danger" role="alert">{{ $errors->first('montant') }}</div>
                    @endif
                </div>
            ...
            <option value="AS  American Samoa">American Samoa</option>
              ...
              <option value="WF  Wallis and Futuna">Wallis and Futuna</option>
                ...
                <div class="col-md-12 text-center">
                  ...
                  <div class="sent-message">Opération effectuée avec succès !</div>

                  <button type="submit" name="SaveAccount">Emprunter </button>
