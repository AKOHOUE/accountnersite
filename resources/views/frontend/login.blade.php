    ...
    <section id="get-a-quote" class="get-a-quote">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-7">
            		<form id="SignupForm" action="{{ route('front.loginFrontPost') }}" method="post" class="php-email-form">
			            @csrf
                  @if($errors->all())
           ...
           <div class="row gy-4">
                <div class="col-md-12">
                  <input type="email" class="form-control"  name="email" value="{{ old('email') }}" placeholder="Votre email" required>
                   ...
                   <div class="col-md-12">
                  <input type="password" class="form-control" name="password"  value="{{ old('password') }}" placeholder="Votre mot de passe" required>
                ...
                <div class="col-md-12 text-center">
                  ...
                  <div class="sent-message">Connexion établie avec succès !</div>

                  <button type="submit" name="connexionBtn">Connexion </button>
                </div>
