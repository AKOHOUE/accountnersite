    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <p data-aos="fade-up" style=" font-family: Times New Roman, Times, serif; size:16px" data-aos-delay="100" style="color: ">Comptez sur des récompenses, des économies, des perspectives et bien plus encore avec tout compte admissible. Seulement à GlobalServicesBk(Global Services BK).</p>
        </h3>
            ...
            <ul>
              <li data-aos="fade-up" data-aos-delay="100">
                 <div>
                  ...
                  <p>
Né il y a plus de 75 ans au Mali,  GlobalServicesBk(Global Services BK) compte aujourd’hui près de 6 000 collaborateurs.
...
Je suis fière de me faire accompagner par GlobalServicesBk(Global Services BK) dans la réalisations de mes projets professionnels.              
     <i class="bi bi-quote quote-icon-right"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
Le groupe le plus scial que GlobalServicesBk(Global Services BK) je n'ai pas encore vu dans dans le monde.                  
<i class="bi bi-quote quote-icon-right"></i>
                </p>
              </div>
            </div><!-- End testimonial item -->
